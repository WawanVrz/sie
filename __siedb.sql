...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jul 2017 pada 05.05
...
(2, 2, 1, 'wiki', 'wiki', 12314, 'P', 'wiki@wiki.wiki', 2017);
...
(1, 1, 'putu', 'putu', 123123, 'putu@putu.com', 'l', 'putu', 'putu', 1),
(2, 1, 'made', 'made', 12312, 'made@gmail.com', 'l', 'made', 'made', 2);
...
--
ALTER TABLE `tbcabang`
  MODIFY `id_cab` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
