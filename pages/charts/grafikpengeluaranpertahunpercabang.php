...
<script src="../../js/xepOnline.jqPlugin.js"></script>
    ...
    var options = {
            title: 'Grafik Data Dana Pengeluaran Monarch Bali Percabang Pertahun',
            width: 900,
            height: 500,
    };
        ...
        <div class="container-fluid">
			...
			<div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Grafik Jumlah Pengeluaran Per Tahun Per Cabang &nbsp;&nbsp;&nbsp;<a href="../../refresh4.php" style="background-color: #05007E !important;" class="btn btn-success">Refresh</a></h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="../../export-data-pengeluaran-percabang-pertahun.php" class="btn btn-info waves-effect custom">Export PDF Data Table</a></li>
