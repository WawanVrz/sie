...
<?php
	...
	$result = $db->query("SELECT tahun, SUM(biaya) AS jumlah FROM `tbpengeluaran` GROUP BY `tahun` ORDER BY tahun ASC");
?>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    GRAFIK PENGELUARAN DANA MONARCH
                </h2>
            </div>
												...
												<div class="header">
														...
														<ul class="header-dropdown m-r--5">
																<li class="dropdown">
																		...
																		<ul class="dropdown-menu pull-right">
                                                                            <li><a href="../../export-data-pengeluaran.php" class="btn btn-info waves-effect custom">Export PDF Data Table</a></li>
