...
<?php
	...
	$result = $db->query("SELECT COUNT(tbpeserta.id_jurusan) as jumlahorang, tbjurusan.nama_jurusan as jurusan, tbjurusan.id_jurusan FROM tbpeserta JOIN tbjurusan ON tbjurusan.id_jurusan = tbpeserta.id_jurusan GROUP by tbjurusan.id_jurusan");
?>
<html>
<head>
    <meta charset="UTF-8">
...
<script src="../../js/xepOnline.jqPlugin.js"></script>
    <!-- =============================================== FUNCTION GOOGLE CHARTS ================================= -->
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Perbandingan Mahasiswa Monarch Bali Per Jurusan',
                width: 900,
                height: 500,
            };
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    GRAFIK PERBANDINGAN JUMLAH MAHASISWA PER JURUSAN
                </h2>
            </div>
						...
						<div class="row clearfix">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="card">
												<div class="header">
														<h5>
																Data Perbandingan Mahasiswa Per Jurusan
														</h5>
														<ul class="header-dropdown m-r--5">
																<li class="dropdown">
																		...
																		<ul class="dropdown-menu pull-right">
                                                                            <li><a href="../../export-mahasiswa-perjurusan.php" class="btn btn-info waves-effect custom">Export PDF Data Table</a></li>
